    ...
    return (
        <View style={styles.mainContainer}>
            <View style={{ width: '100%', height: '12%', flexDirection: 'row', marginTop: '0.5%', borderBottomColor: "#666666", borderBottomWidth: 2, paddingBottom: 10 }}>
                ...
                <View style={{ width: '85%', height: '100%', alignItems: 'flex-start' }}>
                    <View style={styles.search_bar}>
                        <TextInput style={{ height: '80%', width: '98%', marginTop: 3 }} placeholder={"Search..."} onChangeText={(text) => barSearchUpdates(text)} />
                    </View>
                    <TouchableOpacity style={styles.filter_button} activeOpacity={0.5} onPress={() => navigateFilters()}>
